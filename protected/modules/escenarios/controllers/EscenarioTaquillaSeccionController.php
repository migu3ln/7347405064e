...
class EscenarioTaquillaSeccionController extends AweController {
    ...
    public function actionAdmin() {
        $model = new EscenarioTaquillaSeccion('search');
        $model->unsetAttributes(); // clear any default values
        if (isset($_GET['EscenarioTaquillaSeccion']))
            $model->attributes = $_GET['EscenarioTaquillaSeccion'];
    ...
    public function loadModel($id, $modelClass = __CLASS__) {
        $model = EscenarioTaquillaSeccion::model()->findByPk($id);
        if ($model === null)
