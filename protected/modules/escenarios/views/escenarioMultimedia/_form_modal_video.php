...
/** @var EscenarioultimediaController $this */
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            $form = $this->beginWidget('ext.AweCrud.components.AweActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('/escenarios/escenarioMultimedia/ajaxCreate/escenario_id/' . $model->escenario_id . '/tipo/' . Constants::MULTIMEDIA_TIPO_VIDEO),
            ...
            <div class="form-group">
                <div class="col-lg-10 col-lg-offset-2">
                    <button id="btn_save_multimedia" class="btn btn-success ladda-button" form-id="#escenario-multimedia-form" data-style="expand-right">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    $this->widget('ext.booster.widgets.TbGridView', array(
                        ...
                        'dataProvider' => $model->de_tipo(Constants::MULTIMEDIA_TIPO_VIDEO)->search(),
                        'columns' => array(
                            'ubicacion'
                        )
                    ));
