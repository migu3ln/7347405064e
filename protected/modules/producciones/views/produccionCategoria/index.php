...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ProduccionCategoria::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo ProduccionCategoria::label(2) ?>    </legend>
