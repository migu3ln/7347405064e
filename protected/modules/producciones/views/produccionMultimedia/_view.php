...
<div class="view">
        ...
        <?php if (!empty($data->produccion->nombre)): ?>
        <div class="field">
            <div class="field_name">
                <b><?php echo CHtml::encode($data->getAttributeLabel('produccion_id')); ?>:</b>
            </div>
            <div class="field_value">
                <?php echo CHtml::encode($data->produccion->nombre); ?>
            </div>
        </div>
