...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Produccion::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
			...
			'value'=>($model->produccionCategoria !== null) ? CHtml::link($model->produccionCategoria, array('/produccionCategoria/view', 'id' => $model->produccionCategoria->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
