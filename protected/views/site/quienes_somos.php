...
<!--<img class="img-responsive" src="< ?php echo  Yii::app()->baseUrl."/images/somosteatros.jpg"?>" alt="...">-->
                    <img class="img-responsive" src="<?php echo Yii::app()->baseUrl . "/images/teatros.png" ?>" alt="...">
                    <!--<div class="">-->
                    <!--<div class="">-->
                    <a class="link-image-responsive" href="<?php echo Yii::app()->createUrl('/site/nuestrosTeatros') ?>" ></a>
                    <p>
                    </p>
                    <!--</div>-->
                </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 isotope-item impressionism photorealism" >
            <div class="portfolio-item">
                ...
                <div class="portfolio-thumbnail">
                    ...
                    <a class="link-image-responsive" href="<?php echo Yii::app()->createUrl('/site/nuestrosElencos') ?>" ></a>
