...
<div class="col-lg-12">
    <div class="contenedor-imagenes">
        ...
        <div class="row-fluid isotope" id="isotope-container" >
            ...
            <?php foreach ($producciones as $value) : ?>

                <?php // var_dump($prueba=$value->elencoMultimedias); echo"_---------------------" ?>
                <?php $logo = ProduccionMultimedia::model()->logo_de_produccion($value->id) ?>
                    ...
                    <div class="portfolio-item">
                        ...
                        <div class="portfolio-thumbnail">
                            <img class="img-responsive" src="<?php echo $logo->ubicacion ?>" alt="...">
                                <a class="link-image-responsive" href="<?php echo Yii::app()->createUrl('/site/produccion/id/'.$value->id) ?>" ></a>
                        </div>
                    </div> <!-- / .portfolio-item -->
                </div>
