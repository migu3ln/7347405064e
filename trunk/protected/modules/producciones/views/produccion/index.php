...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Produccion::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo Produccion::label(2) ?>    </legend>
