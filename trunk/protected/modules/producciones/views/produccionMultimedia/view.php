...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ProduccionMultimedia::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'produccion_id',
			'value'=>($model->produccion !== null) ? CHtml::link($model->produccion, array('/produccion/view', 'id' => $model->produccion->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
