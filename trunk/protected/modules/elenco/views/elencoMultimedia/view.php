...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ElencoMultimedia::label(2), 'icon' => 'list', 'url' => array('index')),
...
<?php $this->widget('booster.widgets.TbDetailView',array(
	...
	'attributes' => array(
             ...
             array(
			'name' => 'elenco_id',
			'value'=>($model->elenco !== null) ? CHtml::link($model->elenco, array('/elenco/view', 'id' => $model->elenco->id)).' ' : null,
			'type' => 'html',
		),
	),
)); ?>
