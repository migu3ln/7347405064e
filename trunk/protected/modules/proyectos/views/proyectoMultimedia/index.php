...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . ProyectoMultimedia::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo ProyectoMultimedia::label(2) ?>    </legend>
